...
![Dagster assets list](dagster_assets_list.png)

### 2. Global Asset Lineage Graph (Dagster UI)
![Dagster global asset lineage](dagster_asset_lineage.png)

### 3. Successful Run Detail (Dagster UI)
![Dagster run success detail](dagster_run_success.png)

### 4. Runs List (Dagster UI)
![Dagster runs list](dagster_runs_list.png)

### 5. Code Location Overview (Dagster UI)
![Dagster code location overview](dagster_code_location.png)

### 6. Full Pipeline Log (`orchestrator.py`)
![Orchestrator full run output](orchestrator_full_run.png)

### 7. Pipeline Start / Stage-by-Stage Log (Notebook)
![Notebook pipeline start log](notebook_pipeline_start.png)

### 8. Final Notification Summary (CLI)
![CLI notification summary](cli_notification_summary.png)
